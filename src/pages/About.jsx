    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="container mx-auto px-6 py-12 text-center">
        ...
        <p className="text-gray-600 mt-4">
          At Third Limb Yoga, our mission is to promote health, mindfulness, and
          well-being through the ancient practice of yoga. We strive to create a
          community where individuals of all levels can experience balance,
          flexibility, and peace.
        </p>

        <h2 className="text-3xl font-bold text-gray-800 mt-12">Our Vision</h2>
        <p className="text-gray-600 mt-4">
          We envision a world where yoga is accessible to all, fostering inner
          harmony and physical strength. Our AI-powered guidance and
          personalized routines help each student reach their full potential.
        </p>
      </div>
      ...
      <div className="bg-gray-100 py-12">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-gray-600 mt-4">
            Our passionate and certified yoga instructors are here to guide you.
          </p>
